...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog1.setText("Adds : FastTime");

			if(GetLang == "fr_FR")changelog1.setText('Ajoute : FastTime');
			...
			changelog2.setText("New : Timer");

			if(GetLang == "fr_FR")changelog2.setText('Nouveau : Timer');
