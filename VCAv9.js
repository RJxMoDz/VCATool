...
//Block.defineBlock(84, "§l§o§aLucky Block", ["daylight_detector_side", 0], false, false, false);
...
function mainMenu4(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog.setText("New : Mini Map");

			if(GetLang == "fr_FR")changelog.setText('Nouveau : Mini Carte');
