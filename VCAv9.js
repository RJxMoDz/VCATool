...
var derpleftch = false;

var derpleft;

var derpsleft = false;

var derprightch = false;

var derpright;

var derpsright = false;
...
Item.setCategory(253, 3);

Player.addItemCreativeInv(253, 1, 0);

Item.setCategory(254, 3);

Player.addItemCreativeInv(254, 1, 0);

ModPE.langEdit("menu.copyright","§aVCA v9 §6| §f95 Mods Loaded");

if(GetLang == "fr_FR")ModPE.langEdit("menu.copyright","§aVCA v9 §6| §f95 Mods Chargés");
    ...
    var r  = new java.lang.Runnable(){
        ...
        run: function(){
            ...
            try{
                ...
                clientMessage("§a<VCA v9> Exclusive Version : " + newUpdate);

                }

                else if(version + "\n" == checkedVersion){

                clientMessage("§a<VCA v9> Version : " + version);
...
function mainMenu(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			derpleft = new Switch(ctx);

			derpleft.setText("-Derp");

			derpleft.setTypeface(VCAv9.font);

			derpleft.setTextColor(Color.RED);

			derpleft.setChecked(derpleftch);

			derpleft.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
				...
				onCheckedChanged: function(){
					...
					if(!derpleftch){
						...
						derpleft.setTextColor(Color.GREEN);
			...
			derpright = new Switch(ctx);

			derpright.setText("-Earthquake");

			derpright.setTypeface(VCAv9.font);

			derpright.setTextColor(Color.RED);

			derpright.setChecked(derprightch);

			derpright.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
				...
				onCheckedChanged: function(){
					...
					if(!derprightch){
						...
						derpright.setTextColor(Color.GREEN);
			...
			var aw = new Button(ctx);

			aw.setTextSize(30);

			aw.setText("AntiWeb");

			aw.setTransformationMethod(null);

			if(GetLang == "fr_FR")aw.setText("Anti Toile d'Araignée");

			aw.setTypeface(VCAv9.font);

			aw.getBackground().setColorFilter(Color.TRANSPARENT, android.graphics.PorterDuff.Mode.MULTIPLY);

			aw.setTextColor(Color.GREEN);

			aw.setGravity(Gravity.CENTER);
			...
			aw.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					Block.defineBlock(30, "§l§o§aAntiWeb", [["web", 0]], 30, true, 0);

				}

			}}));

			menuLayout.addView(aw);

			var allig = new Button(ctx);

			allig.setTextSize(30);

			allig.setText("Ballooning [Mobs]");

			allig.setTransformationMethod(null);

			if(GetLang == "fr_FR")allig.setText('Montgolfière [Animaux]');
			...
			if(GetLang == "fr_FR")fss.setText('Sable Rapide');
			...
			sl.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					Block.defineBlock(8, "§l§o§aSolidWater", [["still_water", 0]], 8, false, 4);

					Block.defineBlock(9, "§l§o§aSolidStationaryWater", [["still_water", 0]], 9, false, 4);

					Block.defineBlock(10, "§l§o§aSolidLava", [["still_lava", 0]], 10, false, 4);

					Block.defineBlock(11, "§l§o§aSolidStationaryLava", [["still_lava", 0]], 11, false, 4);
...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog1.setText("Add : AntiCactus, AntiWeb, AutoSword, BlockFire, Dolphin, FastSoulSand, PlayerTracers and SolidLiquid");

			if(GetLang == "fr_FR")changelog1.setText("Ajoute : AntiCactus, Anti Toile d'Araignée, AutoSword, Bloc de Feu, Dolphin, Liquide Solide, PlayerTracers et Sable Rapide");
...
function mainMenu3(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			hi.setText("-Health Indicator [+ Players]");
			...
			if(GetLang == "fr_FR")start.setText('Jouer à HyperTunnel');
			...
			if(GetLang == "fr_FR")reset.setText('Tous Réinitialiser');
...
function mainMenu4(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			infos8.setText("Mod Menu Version : " + version);

			if(GetLang == "fr_FR")infos8.setText("Version du Mod Menu : " + version);
			...
			var infos9 = new TextView(ctx);

			infos9.setTextSize(44);

			infos9.setText("User Name : " + ModPE.getPlayerName());

			if(GetLang == "fr_FR")infos9.setText("Nom D'utilisateur : " + ModPE.getPlayerName());

			infos9.setTypeface(VCAv9.font);

			infos9.setTextColor(Color.GREEN);

			infos9.setGravity(Gravity.CENTER);

			menuLayout.addView(infos9);
