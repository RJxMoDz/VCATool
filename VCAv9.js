...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog1.setText("Adds : CreativeFly");

			if(GetLang == "fr_FR")changelog1.setText('Ajoute : CreativeFly');
			...
			changelog2.setText("New : Flight");

			if(GetLang == "fr_FR")changelog2.setText('Nouveau : Flight');
