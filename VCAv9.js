...
ModPE.langEdit("menu.copyright","§aVCA v9 §6| §f90 Mods Loaded");

if(GetLang == "fr_FR")ModPE.langEdit("menu.copyright","§aVCA v9 §6| §f90 Mods Chargés");
...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			if(GetLang == "fr_FR")changelog1.setText('Corrige : Tous les Bugs');
			...
			var changelog2 = new TextView(ctx);

			changelog2.setTextSize(44);

			changelog2.setText("New : Mod Menu");

			if(GetLang == "fr_FR")changelog2.setText('Nouveau : Mod Menu');

			changelog2.setTypeface(VCAv9.font);

			changelog2.setTextColor(Color.GREEN);

			changelog2.setGravity(Gravity.CENTER);

			menuLayout.addView(changelog2);

			var changelog3 = new TextView(ctx);

			changelog3.setTextSize(44);

			changelog3.setText("Shortly : AutoSword");

			if(GetLang == "fr_FR")changelog3.setText('Prochainement : AutoSword');

			changelog3.setTypeface(VCAv9.font);

			changelog3.setTextColor(Color.GREEN);

			changelog3.setGravity(Gravity.CENTER);

			menuLayout.addView(changelog3);
...
function mainMenu4(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			infos3.setText("Bypass and OptiFine");

			if(GetLang == "fr_FR")infos3.setText('Bypass et OptiFine');
