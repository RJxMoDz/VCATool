    ...
    var r  = new java.lang.Runnable(){
        ...
        run: function(){
            ...
            try{
                ...
                clientMessage("<§aVCA v9§f> Version : " + version + " | Internet : ON");
                ...
                if(error == "JavaException: java.net.UnknownHostException: raw.githubusercontent.com"){
                                ...
                                clientMessage("<§aVCA v9§f> Version : " + version + " | Internet : OFF");
...
function mainMenu1(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			ss.setText("Set Spawn");

			ss.setTransformationMethod(null);

			if(GetLang == "fr_FR")ss.setText("Mettre un Point d'Apparition");
...
function mainMenu3(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog1.setText("Adds : Random Teleport and Set Spawn");

			if(GetLang == "fr_FR")changelog1.setText("Ajoute : Mettre un Point d'Apparition et Téléportation Aléatoire");
