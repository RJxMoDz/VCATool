...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog1.setText("Adds : Twerk");

			if(GetLang == "fr_FR")changelog1.setText("Ajoute : Twerk");
			...
			changelog2.setText("New : Follow");

			if(GetLang == "fr_FR")changelog2.setText("Nouveau : Follow");
