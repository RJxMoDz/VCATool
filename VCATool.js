...
if(Launcher.isBlockLauncher() || Launcher.isMcpeMaster())Block.defineBlock(84, "§l§o§aLucky Block", ["daylight_detector_side", 0], false, false, false);

Item.setCategory(84, 2);

ModPE.langEdit("menu.copyright", "§aVCA v9 §6| §f" + number + " Modules Loaded");

if(GetLang == "fr_FR")ModPE.langEdit("menu.copyright", "§aVCA v9 §6| §f" + number + " Modules Chargés");
		...
		run: function(){
			...
			try{
				...
				if(version + "\n" != checkedVersion){
					...
					clientMessage("<§aVCA v9§f> Version : " + version + " + Exclusive Version : " + newUpdate + "Internet : ON");

				}

				else if(version + "\n" == checkedVersion){

					clientMessage("<§aVCA v9§f> Version : " + version + " §6| §fInternet : ON");
				...
				clientMessage("<§aVCA v9§f> Version : " + version + " §6| §fInternet : OFF");
...
function mainMenu(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			if(GetLang == "fr_FR")extras.setText('Modifications');
			...
			various.setText("Addons");

			various.setTransformationMethod(null);

			if(GetLang == "fr_FR")various.setText('Extensions');
...
function mainMenu1(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			rootextras.setText(" /Mods");

			if(GetLang == "fr_FR")rootextras.setText(' /Modifications');
			...
			fly.setTypeface(VCAv9.font);

			fly.setTextColor(Color.RED);

			fly.setChecked(flych);
			...
			ii.setText("-Unlimited Items");

			ii.setTypeface(VCAv9.font);

			ii.setTextColor(Color.RED);

			ii.setChecked(iich);

			ii.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
			...
			rtp.setText("-RandomTP [Mobs]");

			rtp.setTypeface(VCAv9.font);

			rtp.setTextColor(Color.RED);

			rtp.setChecked(rtpch);

			rtp.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
			...
			fe.setTypeface(VCAv9.font);

			fe.setTextColor(Color.RED);

			fe.setChecked(fech);

			fe.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
			...
			tap.setText("-TapJumpRun");

			tap.setTypeface(VCAv9.font);

			tap.setTextColor(Color.RED);

			tap.setChecked(jumprunch);

			tap.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
			...
			fast.setText("-FastTime");

			fast.setTypeface(VCAv9.font);

			fast.setTextColor(Color.RED);

			fast.setChecked(fastch);

			fast.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
			...
			steps = new Switch(ctx);

			steps.setText("-Step");

			steps.setTypeface(VCAv9.font);

			steps.setTextColor(Color.RED);

			steps.setChecked(stepsch);
			...
			if(GetLang == "fr_FR")bf.setText('Anti Feu');
			...
			bf.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					Block.defineBlock(51, "§l§o§aAntiFire", [["fire", 0]], 51, true, 0);

					if(GetLang == "fr_FR")Block.defineBlock(51, "§l§o§aAnti Feu", [["fire", 0]], 51, true, 0);
			...
			if(GetLang == "fr_FR")allig.setText('Lever Automatiquement [Animaux]');
			...
			if(GetLang == "fr_FR")fi.setText('Glace Rapide');
				...
				onClick: function(viewarg){
					...
					if(GetLang == "fr_FR")Block.defineBlock(79, "§l§o§aGlace Rapide", [["ice", 0]], 79, false, 4);

					if(GetLang == "fr_FR")Block.defineBlock(174, "§l§o§aGlace Rapide", [["ice", 0]], 174, false, 4);
			...
			fss.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					if(GetLang == "fr_FR")Block.defineBlock(88, "§l§o§aSable des Âmes Rapide", [["soul_sand", 0]], 88, false, 4);
			...
			if(GetLang == "fr_FR")infect.setText("Infecter l'Invincible [Animaux]");
			...
			nw.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					if(GetLang == "fr_FR")Block.defineBlock(30, "§l§o§aPas de Toile d'Araignée", [["web", 0]], 30, true, 0);
			...
			var rt = new Button(ctx);

			rt.setTextSize(30);

			rt.setText("RandomTP [Map]");

			rt.setTransformationMethod(null);

			if(GetLang == "fr_FR")rt.setText('Téléportation Aléatoire [Carte]');

			rt.setTypeface(VCAv9.font);

			rt.getBackground().setColorFilter(Color.TRANSPARENT, android.graphics.PorterDuff.Mode.MULTIPLY);
			...
			menuLayout.addView(rt);

			var ss = new Button(ctx);

			ss.setTextSize(30);

			ss.setText("Set Spawn Position [+ Players]");

			ss.setTransformationMethod(null);

			if(GetLang == "fr_FR")ss.setText("Mettre un Point d'Apparition [+ Joueurs]");

			ss.setTypeface(VCAv9.font);

			ss.getBackground().setColorFilter(Color.TRANSPARENT, android.graphics.PorterDuff.Mode.MULTIPLY);
			...
			sl.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					if(GetLang == "fr_FR")Block.defineBlock(8, "§l§o§aLiquide Solide", [["still_water", 0]], 8, false, 4);

					if(GetLang == "fr_FR")Block.defineBlock(9, "§l§o§aLiquide Solide", [["still_water", 0]], 9, false, 4);

					if(GetLang == "fr_FR")Block.defineBlock(10, "§l§o§aLiquide Solide", [["still_lava", 0]], 10, false, 4);

					if(GetLang == "fr_FR")Block.defineBlock(11, "§l§o§aLiquide Solide", [["still_lava", 0]], 11, false, 4);
			...
			var spawnf = new Button(ctx);

			spawnf.setTextSize(30);

			spawnf.setText("Spawn Fireball");

			spawnf.setTransformationMethod(null);

			if(GetLang == "fr_FR")spawnf.setText('Apparaître une Boule de Feu');

			spawnf.setTypeface(VCAv9.font);

			spawnf.getBackground().setColorFilter(Color.TRANSPARENT, android.graphics.PorterDuff.Mode.MULTIPLY);

			spawnf.setTextColor(Color.GREEN);

			spawnf.setGravity(Gravity.CENTER);

			spawnf.setOnClickListener(new View.OnClickListener({
				...
				onClick: function(viewarg){
					...
					Level.spawnMob(Player.getX(), Player.getY(), Player.getZ(), EntityType.FIREBALL);

				}

			}}));

			menuLayout.addView(spawnf);
...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			rootextrasvarious.setText(" /Addons");

			if(GetLang == "fr_FR")rootextrasvarious.setText(' /Extensions');
			...
			mk.setText("RandomMorph ");

			if(GetLang == "fr_FR")mk.setText('Transformation Aléatoire ');

			mk.setTypeface(VCAv9.font);

			mk.setTextColor(Color.RED);

			mk.setGravity(Gravity.RIGHT);
			...
			if(GetLang == "fr_FR")tc.setText("Choppeur d'Arbres ");

			tc.setTypeface(VCAv9.font);

			tc.setTextColor(Color.RED);

			tc.setGravity(Gravity.RIGHT);
			...
			uidebug = new CheckBox(ctx);

			uidebug.setText("Debug GUI ");

			if(GetLang == "fr_FR")uidebug.setText('Interface Graphique de Développeur ');

			uidebug.setTypeface(VCAv9.font);

			uidebug.setTextColor(Color.RED);

			uidebug.setGravity(Gravity.RIGHT);

			uidebug.setChecked(uidebugch);

			uidebug.setOnClickListener(new View.OnClickListener({
			...
			back = new CheckBox(ctx);

			back.setText("Custom Background ");

			if(GetLang == "fr_FR")back.setText('Arrière-Plan Personnalisé ');

			back.setTypeface(VCAv9.font);

			back.setTextColor(Color.RED);

			back.setGravity(Gravity.RIGHT);
...
function mainMenu3(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			rootextrasinformations.setText(" /Informations");
			...
			var progBar3 = new ProgressBar(ctx, null, android.R.attr.progressBarStyleHorizontal);

			progBar3.setMax(100);

			progBar3.setIndeterminate(true);

			progBar3.setProgress(100);

			menuLayout.addView(progBar3);
			...
			infos1.setText("Thanks AJ170, ArceusMatt, FirePro9978, Flubberlutsch, Godsoft029, MxGoldo, MyNameIsTriXz, peacestorm, VeroXCode and wilco375 for Things");

			if(GetLang == "fr_FR")infos1.setText('Merci AJ170, ArceusMatt, FirePro9978, Flubberlutsch, Godsoft029, MxGoldo, MyNameIsTriXz, peacestorm, VeroXCode et wilco375 pour des Choses');
			...
			infos2.setText("Remains : RJxMoDz");

			if(GetLang == "fr_FR")infos2.setText('Restes : RJxMoDz');
			...
			mod.setText("Mods Enabled :");

			if(GetLang == "fr_FR")mod.setText('Mods Activé :');
			...
			infos3.setText("Bypass, Lucky Block and Textures");

			if(GetLang == "fr_FR")infos3.setText('Contournement, Lucky Block et Textures');
...
function mainMenu4(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			rootextraschangelog.setText(" /Changelog");

			if(GetLang == "fr_FR")rootextraschangelog.setText(' /Changement');
			...
			changelog.setText("Added : RandomTP [Mobs]");

			if(GetLang == "fr_FR")changelog.setText('Ajoute : RandomTP [Mobs]');

			changelog.setTypeface(VCAv9.font);
			...
			changelog1.setText("New : Mod Menu");

			if(GetLang == "fr_FR")changelog1.setText('Nouveau : Mod Menu');
...
function deathHook(attacker, victim){
	...
	if(morphkill){
		...
		if(attacker == getPlayerEnt()){
			...
			Entity.setRenderType(getPlayerEnt(), victim);
...
function entityAddedHook(entity){
	...
	if(Entity.getEntityTypeId(entity) == 80 && unlimiteditems == true){
...
function useItem(x, y, z, itemId, itemDamage, blockId, side){
	...
	if(unlimiteditems){
		...
		Player.addItemInventory(itemId, 1, itemDamage);
...
function resetGame(){
	if(gameProgress-4 == 5000) clientMessage("<§aVCA v9§f> Score Maximun : 5000")
	else clientMessage("<§aVCA v9§f> Score : " + (gameProgress-4));
	gameProgress = 0;
	gameStarted = 0;
	topBlocks = [];
	bottomBlocks = [];
...
mapWindow = function() {
    ...
    textInfo.setTypeface(VCAv9.font);
    ...
    btnZoomOut.setTypeface(VCAv9.font);
    btnZoomOut.setId(3);
    ...
    btnZoomIn.setTypeface(VCAv9.font);
    btnZoomIn.setId(4);
