...
function mainMenu3(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			infos1.setText("Remains : RJxMoDz");

			if(GetLang == "fr_FR")infos1.setText('Restes : RJxMoDz');
			...
			if(GetLang == "fr_FR")infos3.setText('Bypass, Lucky Block et Textures');
