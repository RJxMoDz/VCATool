...
function mainMenu1(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			if(GetLang == "fr_FR")rt.setText('Téléportation Aléatoire');
...
function mainMenu2(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			mk.setText("-AutoMorph");

			if(GetLang == "fr_FR")mk.setText('-Se Transformer Automatiquement');
			...
			mk.setOnCheckedChangeListener(new android.widget.CompoundButton.OnCheckedChangeListener({
...
function mainMenu4(){
	...
	ctx.runOnUiThread(new Runnable({ run: function(){
		...
		try{
			...
			changelog.setText("Fix : All Bugs");

			if(GetLang == "fr_FR")changelog.setText('Corrige : Tout les Bugs');
			...
			changelog1.setText("New : God Mode and Unlimited Items");

			if(GetLang == "fr_FR")changelog1.setText('Nouveau : God Mode et Unlimited Items');
